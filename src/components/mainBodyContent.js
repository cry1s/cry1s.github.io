        ...
        <div class="justify-content-center  bg-info p-2">
            ...
            <div class="container">
                <div class="row justify-content-center my-3">
                    <button class="col-auto rounded-circle active" onClick={() => setCurday(0)}>РџРЅ</button>
                    <button class="col-auto rounded-circle" onClick={() => setCurday(1)}>Р’С‚</button>
                    <button class="col-auto rounded-circle" onClick={() => setCurday(2)}>РЎСЂ</button>
                    <button class="col-auto rounded-circle" onClick={() => setCurday(3)}>Р§С‚</button>
                    <button class="col-auto rounded-circle" onClick={() => setCurday(4)}>РџС‚</button>
                    <button class="col-auto rounded-circle" onClick={() => setCurday(5)}>РЎР±</button>
                    <button class="col-auto rounded-circle" onClick={() => setCurday(6)}>Р’СЃ</button>
                </div>
