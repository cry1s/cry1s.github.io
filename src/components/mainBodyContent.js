...
<div class="row justify-content-center">
                    <div class="col-12 col-sm-12 col-md-8 col-lg-6 col-xl-5 px-3 my-3">
                       <div class="container border shadow bg-light justify-content-between rounded d-flex ">
                ...
                <h3 class="mt-1 py-0">{curweek} неделя</h3>
            ...
            <div class="container justify-content-center">
                ...
                <div class="col"><AddSubject userindex={props.userindex} curweek={curweek} curday={curday + (props.user.twoweeks && curweek % 2 == 0) * 7} setuser={props.setuser}/></div>
                </div>
                </div>
        </div>
    );
